    ...
    \chapter{Serie de Fourier}
        ...
        \section{Tips para Encontrar los Coeficientes}
            ...
            \subsection{Encontrar a $a_0$}
                ...
                Podemos decir informalmente que $\dfrac{a_0}{2}$ representa el área
                bajo la curva de un periodo de nuestra función, veamos unos ejemplos:

                \begin{figure}[h]
                    \centering
                    \includegraphics[width=0.35\textwidth]{SerieFourierEjemplo1}
                    \caption{Ve que como el area positiva como el area negativa es
                    igual al final $\frac{a_0}{2}=0$}
                \end{figure}
