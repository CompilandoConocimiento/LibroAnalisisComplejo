                ...
                \begin{SmallIndentation}[1em]
                    ...
                    \begin{MultiLineEquation*}{3}
                        \InvFourierT{U(w, t)}
                            ...
                            &= \pi
                                \InvFourierT{
                                    e^{-3|w|} \;\; \frac{2(1)}{w} \Sin{2wt}
                                }
                                && \Remember{Acomodamos}                                            \\
                            &=  \pi \; \frac{2(3)}{3^2 + x^2} * [u(x+2t) -u(x-2t)]
                                && \Remember{Convolución}                                           \\
                            &= 
                                6\pi \int_{-\infty}^{\infty} \frac{1}{3^2 + (t-x)^2} [u(x+2t) -u(x-2t)]
                                && \Remember{Aplicamos}                                             \\
                            &= 
                                6\pi \int_{-2t}^{2t} \frac{1}{3^2 + (x-t)^2}
                                && \Remember{Aplicamos}                                             \\
                    \end{MultiLineEquation*}

                    Por lo tanto nuestra función que cumple con todas las condiciones es:
                    \begin{MultiLineEquation*}{3}
                        u(x, t) = 6\pi \int_{-2t}^{2t} \frac{1}{9 + (x-t)^2}
                    \end{MultiLineEquation*}
