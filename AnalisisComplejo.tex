            ...
            \begin{itemize}
                ...
                \item
                    ...
                    \begin{SmallIndentation}[1em]
                        ...
                        Dado a $z = a+ib$
                        \begin{MultiLineEquation*}{2}
                            \dfrac{z-\Over{z}}{2}   &= \dfrac{(a+bi) - (a-bi)}{2i}
                                                     = \dfrac{2bi}{2i}
                                                     = b                            \\
                                                    &= Im(a + bi)
                        \end{MultiLineEquation*}
        ...
        \section{Inverso Multiplicativo}
            ...
            \begin{itemize}
                ...
                \item
                    Gracias al inciso anterior podemos separar la parte real y la imaginaria como:
                    \begin{equation}
                        \dfrac{1}{z} = \dfrac{\Over{z}}{|z|^2}
                    \end{equation}

                    % ======== DEMOSTRACION ========
                    \begin{SmallIndentation}[1em]
                        \textbf{Recuerda}: $\Over{z} = a - bi$ y $|z| = a^2 + b^2$
                    \end{SmallIndentation}
                ...
                \begin{SmallIndentation}[1em]
                    ...
                    \begin{MultiLineEquation*}{3}
                        e^{i\theta} &= 
                                    ...
                                    &&+
                                    \Wrap{\theta - \dfrac{\theta^3}{3!} + \dfrac{\theta^5}{5!} + \cdots}i\\
                                    &= \Cos{\theta} &&+ \Sin{\theta}i
                    \end{MultiLineEquation*}
