...
\clearpage
    ...
    \chapter{Forma Polar y Argumentos}
        ...
        \section{Forma Polar}
            ...
            \subsection{De forma Polar a forma Rectangular}
                ...
                \begin{itemize}
                 ...
                 Otra forma de escribirlo es $r(\cos(\theta) +ivtt\sin(\theta))$
        ...
        \section{Leyes de Aritmetica}
            ...
            es decir $z_1 = r_1(\cos(\theta_1) + i\sin(\theta_1)$ y $z_2 = r_2(\cos(\theta_2) + i\sin(\theta_2)$
            entonces tenemos que:
            ...
            \begin{itemize}
                \item
                    ...
                    \begin{SmallIndentation}[1em]
                        ...
                        \begin{itemize}
                            \item $cos(a\pm b) = cos(a)cos(b) \mp sen(a)sin(b)$
                ...
                \item
                    ...
                    \begin{SmallIndentation}[1em]
                        ...
                        \begin{MultiLineEquation*}{2}
                            \frac{z_1}{z_2} &= \frac{1}{(r_2)^2} (a_1a_2 - b_1b_2) + (a_1b_2 - b_1a_2)i \\
