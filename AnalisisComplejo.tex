...
\clearpage
    ...
    \chapter{Integración}
        ...
        \section{Integrales}
            ...
            Supongamos que tenemos una función $f(z)$ si queremos integrarla tendremos que:
            \begin{MultiLineEquation*}{3}
                \int f(z) dz
                    &= \int f(x+iy) d(x+iy)                                                 \\
                    &= \int u_{(x, y)} + iv_{(x, y)} (dx+idy)                               
            \end{MultiLineEquation*}
        ...
        \section{Integrales de Línea}
            ...
            Supongamos que tenemos una función $f(z)$ si queremos integrarla a lo largo de 
            una curva $\mathcal{C}$ como:

            \begin{equation}
                \int_{\mathcal{C}} f(z) dz = \int_a^b f\Wrap{z(t)} \;z'(t) \; dt
            \end{equation}

            Donde $z(t)$ es una función parametrica de $z$.
