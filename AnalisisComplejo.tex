...
\clearpage
    ...
    \chapter{Serie de Fourier}
        ...
        \section{Aplicaciones - Problemas de Frontera}
            ...
            \subsection{Ecuación de Onda en una Dimensión}
                ...
                sufre la cuerda en un tiempo t. Supongamos que el desplazamiento
                inicial esta dado por $f(x)$ y donde $c^2$ es una constante
                    ...
                    \begin{MultiLineEquation*}{3}
                        u(x,t)
                            ...
                            &= \sum_{n=1}^\infty
                                    \Sin{\frac{n \pi x}{l}}
                                    \Wrap{
                                        E_n \Cos{\frac{cn\pi}{l}}t +
                                        F_n \Sin{\frac{cn\pi}{l}}t
                                    }
                    \end{MultiLineEquation*}
    ...
    \chapter{Transformada de Fourier}
        ...
        \section{Transformadas más Famosas}
            ...
            % =====    TRANSFORMADA MAS FAMOSAS      =======
            % ==============================================
            \subsection{$\FourierT{t^n f(t)}$ aka Derivada y la Transformada}
                ...
                Por lo tanto $\FourierT{t^n f(t)} = i^n \UpperDerivate{F(w)}{w}{n}$
        ...
        \section{Teoremas Importantes}
            ...
            % ==============================================
            \clearpage
            \subsection{Gran Teorema de la Simetria}
                ...
                a la transformada de $f(t)$ pero en el dominio del tiempo es igual a $2\pi$ por
                $f(-w)$ donde $f(w)$ es algo parecido a $f(t)$ pero en el dominio de la frecuencia.

            % ==============================================
            % =====    CONSECUENCIA DE SIMETRIA      =======
            % ==============================================
            \clearpage
            \subsection{Consecuencias del Gran Teorema de la Simetria}

                % ==============================================
                % =====    TRANSFORMADA MAS FAMOSAS      =======
                % ==============================================
                \subsection{$\FourierT{1}$}
                ...
                % =====    TRANSFORMADA MAS FAMOSAS      =======
                % ==============================================
                \subsection{$\FourierT{\dfrac{1}{\alpha + it}}$}

                    Usando que $\FourierT{u(t) e^{-\alpha t}} = \dfrac{1}{\alpha + it}$ podemos decir que:\\
                    $\FourierT{\dfrac{1}{\alpha + it}} = 2\pi u(-w) e^{\alpha w}$
            ...
            \subsection{Teorema del Escalamiento}
                ...
                \begin{SmallIndentation}[1em]
                    ...
                    Basta con ver que pasa al momento de calcular la transformada de $f(ta)$,
                    eso si antes sea $r=ta$ y $dt = \frac{dr}{a}$
                    \begin{MultiLineEquation*}{3}
                        \FourierT{e^{iw_0 t} f(t)} 
                ...
                % =====    TRANSFORMADA MAS FAMOSAS      =======
                % ==============================================
                \subsection{$\FourierT{f(-t)}$}

                    Usando que $a = - 1$, entonces podemos decir que:\\
                    $\FourierT{f(-t)} = F(-w)$ 
        ...
        % ==============================================
        \clearpage
        \section{Ejemplos de Calcularla}
        ...
        % ===============================================
        \clearpage
        \section{Ejemplos de la Inversa}
        ...
        \section{Convolución}
            ...
            Nota también que $f(t) * g(t) = g(t) * f(t)$
            ...
            esta definición aplica para todas las transformadas.
                ...
                % =====    EJEMPLO           =======
                % ==================================
                \subsection{Ejemplo de Convolución: $\InvFourierT{\frac{1}{(1+iw)^2}}$}
                    ...
                    Por lo tanto creo que es muy obvio que $\InvFourierT{\frac{1}{(1+iw)^2}} = t \; u(t) \; e^{-t}$


                    \textbf{Pero usando Convolución}:
                    \begin{MultiLineEquation*}{3}
        ...
        \section{Transformario de Fourier}
            ...
            \begin{table}[ht]
                \begin{tabular}{|m{16em}|m{16em}|@{}m{0pt}@{}}
                    ...
                    $f(t) \Cos{w_0t}  $     & $\frac{1}{2}[F(w-w_0)+F(w+w_0)]           $ &\\[1em]    \hline\hline
                    $f(t) \Sin{w_0t}  $     & $\frac{1}{2i}[F(w-w_0)-F(w+w_0)]          $ &\\[1em]    \hline\hline
                    $\Cos{w_0t}       $     & $\pi(\delta(-w-w_0)+\delta(-w+w_0))       $ &\\[1em]    \hline\hline
                    $\Sin{w_0t}       $     & $i\pi(\delta(-w+w_0)-\delta(-w-w_0))      $ &\\[1em]    \hline\hline
                    $e^{-\alpha|t|}   $     & $\frac{2\alpha}{\alpha^2+w^2}             $ &\\[1em]    \hline\hline
                    $\frac{1}{a^2+w^2}$     & $\frac{\pi}{a} e^{-a |w|}                 $ &\\[1em]    \hline\hline
