...
% ========================================
    ...
    \newcommand \MiniUpperDerivate[2]                               %Mini Derivate High Orden Derivate -- [x][1]
        {\dfrac{d^{#2}}{d^{#2}#1}}                                  %Mini Derivate High Orden Derivate
    \newcommand \UpperDerivate[3]                                   %Complete High Orden Derivate -- [f(x)][x][1]
        {\dfrac{d^{#3} \; #1}{d^{#3} #2}}                           %Use: \UpperDerivate for simple use
    ...
    \newcommand \MiniUpperPartial[2]                                %Mini Derivate High Orden Derivate -- [x][1] 
        {\dfrac{\partial^{#2}}{\partial^{#2}#1}}                    %Mini Derivate High Orden Derivate
    \newcommand \UpperPartial[3]                                    %Complete High Orden Derivate -- [f(x)][x][1]
        {\dfrac{\partial^{#3} \; #1}{\partial^{#3} #2}}             %Use: \UpperDerivate for simple use
    ...
    \chapter{Series Complejas}
        ...
        \section{Series de Laurent}
            ...
            \subsection{Coeficientes}
                ...
                Podemos decir que los coeficientes de la Serie de Laurent son:
                \begin{equation*}
                    a_k = \dfrac{1}{2\pi i} \oint_C \dfrac{f(s) ds}{(s - z_0)^{k+1}}
                \end{equation*}
            ...
            \subsection{Polos y Singularidades Aisladas}
                ...
                \begin{itemize}
                    \item Si la parte principal de nuestra Serie de Laurent no tiene elementos
                        entonces decimos que existe una singularidad removible.

                        $a_0 + a_1(z-z_0) + a_2(z-z_0)^2 + \cdots$

                    \item Si la parte principal de nuestra Serie de Laurent tiene una cantidad
                        finita de elementos entonces decimos que tenemos un Polo de Orden $n$.

                        Si es que tenemos solo un elemento decimos que es un Polo Simple

                        $a_{-n}(z - z_0)^{-n} + \cdots + a_{-1}(z - z_0)^{-1}+ a_0 + a_1(z-z_0)
                            + a_2(z-z_0)^2 + \cdots$

                    \item Si la parte principal de nuestra Serie de Laurent tiene una cantidad
                        infinita de elementos entonces decimos que tenemos una Singularidad
                        escencial 

                        $\cdots + a_{-2}(z - z_0)^{-2} + a_{-1}(z - z_0)^{-1}+ a_0 + a_1(z-z_0)
                            + a_2(z-z_0)^2 + \cdots$
                \end{itemize}
    ...
    \chapter{Residuos} 
        \clearpage
            ...
            \section{Encontrar Residuos}
                ...
                % =====    RESIDUO E INTEGRAL  ========
                % =====================================
                \subsection{Residuo e Integral}

                    Ahora recuerda que ya habiamos dado una formula para poder saber el valor
                    del residuo como:
                    \begin{equation*}
                        a_{-1} = \dfrac{1}{2 \pi i} \oint f(z) dz 
                    \end{equation*}

                    Como resulta ser mucho más fácil encontrar los residuos que la integral
                    entonces generalmente decimos que:
                    \begin{equation*}
                        (2 \pi i) a_{-1} = \oint f(z) dz 
                    \end{equation*}
